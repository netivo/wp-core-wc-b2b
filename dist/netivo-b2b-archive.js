/******/ (() => { // webpackBootstrap
/*!***********************************************!*\
  !*** ./sources/javascript/entries/archive.js ***!
  \***********************************************/
/* b2b_popup_vars */

document.addEventListener("DOMContentLoaded", () => {
  const products = document.querySelectorAll(".b2b-content-loop-product .woocommerce-loop-product__title");
  ...
  products.forEach(product => {
    product.addEventListener("click", event => {
      ...
      const product_id = product.closest(".b2b-content-loop-product").dataset.productId;
...
/******/ })()
;
//# sourceMappingURL=netivo-b2b-archive.js.map